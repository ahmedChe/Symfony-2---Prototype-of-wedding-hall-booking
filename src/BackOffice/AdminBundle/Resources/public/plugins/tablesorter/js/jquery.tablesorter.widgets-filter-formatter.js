...
$.tablesorter.filterFormatter = {
	...
	html5Number : function($cell, indx, def5Num) {
		...
		// Template browser for HTML5 range support
		$number = $('<input type="number" style="visibility:hidden;" value="Template">').appendTo($cell),
		// Template if HTML5 number is supported - from Modernizr
	...
	html5Color: function($cell, indx, defColor) {
		...
		// Add a hidden input to hold the range values
		$color = $('<input type="color" style="visibility:hidden;" value="Template">').appendTo($cell),
