...
namespace FrontOffice\StaticBundle\Tests\Controller;
...
class ResponsableControllerTest extends WebTestCase
{
    ...
    public function testCompleteScenario()
    {
        ...
        $form = $crawler->selectButton('Create')->form(array(
            'frontoffice_staticbundle_responsable[field_name]'  => 'Test',
        ...
        $form = $crawler->selectButton('Update')->form(array(
            'frontoffice_staticbundle_responsable[field_name]'  => 'Foo',
            // ... other fields to fill
        ));
