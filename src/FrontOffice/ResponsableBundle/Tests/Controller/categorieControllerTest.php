...
namespace FrontOffice\ResponsableBundle\Tests\Controller;
...
class categorieControllerTest extends WebTestCase
{
    ...
    public function testCompleteScenario()
    {
        ...
        $form = $crawler->selectButton('Create')->form(array(
            'frontoffice_responsablebundle_categorie[field_name]'  => 'Test',
        ...
        $form = $crawler->selectButton('Update')->form(array(
            'frontoffice_responsablebundle_categorie[field_name]'  => 'Foo',
            // ... other fields to fill
        ));
